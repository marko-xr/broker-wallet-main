...
class AddOffersView extends StatelessWidget {
  final AddOffersMode mode;
  final String? offerId;
  final OfferModel? offerData;

  const AddOffersView({
    super.key,
    this.mode = AddOffersMode.add,
    this.offerId,
    this.offerData,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => AddOffersViewModel(
        mode: mode,
        offerId: offerId,
        offerData: offerData,
      ),
      child: Consumer<AddOffersViewModel>(
        builder: (context, vm, _) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                  vm.isEditMode
                      ? localization.translate('editOffer')
                      : localization.translate('offers'),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 18),
                          _Label(localization
                              .translate('typeOfOfferPropertiesAlt')),
                          _TypeChips(
...
// ----- WIDGETS (Reusable/Atomic) -----

class _RentSellTabs extends StatelessWidget {
  final OffersTab tab;
  final ValueChanged<OffersTab> onChanged;
        ...
        children: [
          Expanded(
            child: GestureDetector(
              onTap: () => onChanged(OffersTab.rent),
              child: Container(
                decoration: BoxDecoration(
                  color: tab == OffersTab.rent
                      ? colors.primary
                      : Colors.transparent,
                  borderRadius: BorderRadius.circular(26), // Adjusted to match
                ),
                ...
                child: Text(
                  ...
                  style: AppTextStyles.tabText.copyWith(
                    color:
                        tab == OffersTab.rent ? Colors.white : colors.onSurface,
                  ),
                ),
              ),
            ),
          ...
          Expanded(
            child: GestureDetector(
              onTap: () => onChanged(OffersTab.sell),
              child: Container(
                decoration: BoxDecoration(
                  color: tab == OffersTab.sell
                      ? colors.primary
                      : Colors.transparent,
                  borderRadius: BorderRadius.circular(26), // Adjusted to match
                ),
                ...
                child: Text(
                  ...
                  style: AppTextStyles.tabText.copyWith(
                    color:
                        tab == OffersTab.sell ? Colors.white : colors.onSurface,
                  ),
                ),
              ),
            ),
...
// Helper for localization keys for cities
