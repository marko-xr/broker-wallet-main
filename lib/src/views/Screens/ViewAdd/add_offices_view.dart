...
import 'package:broker_wallet/src/viewmodels/AddScreens/add_offices_viewmodel.dart';
import 'package:broker_wallet/src/data/models/ScreensModel/offices_model.dart';

class AddOfficesView extends StatelessWidget {
  final AddOfficesMode mode;
  final String? officeId;
  final OfficeModel? officeData;

  const AddOfficesView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => AddOfficesViewModel(
        mode: mode,
        officeId: officeId,
        officeData: officeData,
      ),
      child: Consumer<AddOfficesViewModel>(
        builder: (context, vm, _) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                  vm.isEditMode
                      ? localization.translate('editOffice')
                      : localization.translate('offices'),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _Label(localization.translate('officeName')),
                          _TextFieldIcon(
                            iconAsset: 'assets/icons/offices-lable.svg',
                            hint: localization.translate('enterOfficeName'),
                            value: vm.officeName,
                            onChanged: vm.setOfficeName,
                          ),
                          const SizedBox(height: 18),
                          _Label(localization.translate('managerName')),
                          _TextFieldIcon(
                            iconAsset: 'assets/icons/profile-person.svg',
                            hint: localization.translate('enterManagerName'),
                            value: vm.managerName,
                          ...
                          const SizedBox(height: 18),
                          _Label(localization.translate('officeLocation')),
                          _TextFieldIcon(
                            iconAsset: 'assets/icons/location-lable.svg',
                            hint: localization.translate('enterOfficeLocation'),
                            value: vm.officeLocation,
                            onChanged: vm.setOfficeLocation,
                          ),
                          const SizedBox(height: 18),
                          ...
                          const SizedBox(height: 18),
                          _Label(localization.translate('pickOfficeLocation')),
                          PickUpInputWidget(
...
// --- ATOMIC WIDGETS (REUSE FROM PREVIOUS SCREENS) ---
