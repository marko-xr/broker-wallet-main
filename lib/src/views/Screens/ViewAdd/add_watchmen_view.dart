...
import 'package:broker_wallet/src/viewmodels/AddScreens/add_watchmen_viewmodel.dart';
...
class AddWatchmenView extends StatelessWidget {
  final AddWatchmenMode mode;
  final String? watchmenId;
  final WatchmenModel? watchmenData;

  const AddWatchmenView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => AddWatchmenViewModel(
        mode: mode,
        watchmenId: watchmenId,
        watchmenData: watchmenData,
      ),
      child: Consumer<AddWatchmenViewModel>(
        builder: (context, vm, _) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                  mode == AddWatchmenMode.edit
                      ? localization.translate('editWatchman')
                      : localization.translate('watchman'),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _TextFieldIcon(
                            ...
                            hint: localization.translate('enterWatchmenName'),
                            value: vm.name,
                          ...
                          const SizedBox(height: 18),
                          _Label(localization.translate('buildingName')),
                          _TextFieldIcon(
                            icon: Icons.business_rounded,
                            hint: localization.translate('enterBuildingName'),
                            value: vm.buildingName,
                            onChanged: vm.setBuildingName,
                          ),
                          const SizedBox(height: 18),
                          ...
                          const SizedBox(height: 18),
                          _Label(
                              localization.translate('pickUpBuildingLocation')),
                          PickUpInputWidget(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: SaveCancelButtons(
                            ...
                            isEditMode: mode == AddWatchmenMode.edit,
